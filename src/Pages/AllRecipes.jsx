    ...
    <div>
      ...
      <div className="flex flex-col items-center py-5 gap-4">
        <div className="flex justify-center items-center py-5 ">
          ...
          >
            <option className="bg-green-50" value="All">
              All
            </option>
            <option className="bg-green-50" value="Indian">
              Indian
            </option>
            <option className="bg-green-50" value="Italian">
              Italian
            </option>
            <option className="bg-green-50" value="Chinese">
              Chinese
            </option>
            <option className="bg-green-50" value="Mexican">
              Mexican
            </option>
          </select>
        </div>
        <h1 className="text-xl font-bold text-gray-400">
          Total Recipe <span className="text-green-400"> {data.length}</span>{" "}
          found
        </h1>
      </div>
      <Slide>
