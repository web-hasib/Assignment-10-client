...
const Error = () => {
  ...
  return (
      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-white  transition-colors duration-300 px-4">
      ...
      <h1 className="text-2xl sm:text-3xl font-semibold text-gray-800 mt-6">
